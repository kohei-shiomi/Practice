    ...
    <div>
      ...
      >
        ...
        <CardActions style={{ justifyContent: 'center', padding: '0 0 25px' }}>
          <StyledButton size='large' variant="contained" color='primary' component={Link} to="/Btype">YES</StyledButton>
          <StyledButton size='large' variant="contained" color='secondary' component={Link} to="/Ctype">NO</StyledButton>
        </CardActions>
